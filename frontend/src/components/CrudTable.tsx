    ...
    ...fields
      ...
      .map((f) => ({
        ...
        render: (value: unknown) => {
          ...
          if (f.tag) {
            const color =
              { in_use: "green", active: "green", normal: "green", approved: "green", valid: "green", signed: "cyan", issued: "green", submitted: "orange", repair: "orange", warning: "orange", due_soon: "orange", under_review: "orange", alarm: "red", overdue: "red", rejected: "red", scrapped: "red", sealed: "default", unknown: "default", obsolete: "default" }[
                value as string
              ] || "blue";
